...
function RegisterHealthWorker() {
    ...
    self.add_state(new ChoiceState(
        ...
        _.gettext("We are sorry but you cannot be registered unless" +
                  ...
                  " sure you want to end the registration process?"),
        [
            new Choice("yes", _.gettext("Yes")),
            new Choice("no", _.gettext("No"))
        ]
    ...
    self.add_state(new EndState(
        "session1_end",
        _.gettext("Thank you. You have completed your registration" +
				  " process. Please dial *149*24# " +
                  "at any time to update your profile and for other services."),
        "update_profile",
        {
            on_enter: function () {
                var im = this.im;
