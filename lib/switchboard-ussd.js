...
function RegisterHealthWorker() {
	...
	[
	    new Choice("1", _.gettext("Update my first name")),
            new Choice("2", _.gettext("Update my surname")),
            new Choice("3", _.gettext("Update my Registration Number"))
	]	
    ));
	...
	_.gettext("Thank you! We are working on this, try again later!\n\n Meanwhile, you can update your other details"),
	"check_cug_number"
    ));
	...
	_.gettext("Please enter your surname correctly!")
    ));
	...
	_.gettext("Please enter your registration/license number!\n\nThis is the number you get from your professional body like MCT, TNMC, etc.!")
    ));
	...
	_.gettext("The choice was not correct!"),
        "check_cug_number"
    ));               
	...
	_.gettext("Please enter a number in the format 07XXXXXXXX")    
    ));
    
    self.add_state(new EndState(
	"cug_number_reply_found",
	_.gettext("Thank you! You can call this number free of charge if you are in the CUG"),
        "check_cug_number"
    ));
